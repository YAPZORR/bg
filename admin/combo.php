    ...
    <div class="mainbar">
      ...
      <div class="page-head">
        <h2 class="pull-left"><i class="fa fa-home"></i> Dashboard
          <a href="#addModal" class="btn btn-info" data-toggle="modal">Add New Package Meals</a>
        </h2>
        ...
        <div class="bread-crumb pull-right">
          ...
          <span class="divider">/</span> 
          <a href="#" class="bread-current">Package Meals</a>
        </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title">Delete Package Meals</h4>
            </div>
...
<div id="update<?php echo $id;?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
              <h4 class="modal-title">Update Package Meals</h4>
            </div>
            <div class="modal-body" style="height:300px">
              ...
              <form class="form-horizontal" method="post" action="combo_update.php" enctype='multipart/form-data'>
                  ...
                  <div class="form-group">
                      <label class="control-label col-lg-4" for="title">Package Name</label>
                      <div class="col-lg-8"> 
...
<div id="addModal" class="modal fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
              <h4 class="modal-title">Add New Package Meal</h4>
            </div>
            <div class="modal-body">
              ...
              <form class="form-horizontal" method="post" action="combo_save.php">
                  <!-- Title -->
                  <div class="form-group">
                      <label class="control-label col-lg-3" for="title">Package Name</label>
                      <div class="col-lg-8"> 
