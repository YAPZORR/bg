                ...
                <div class="widget-content">
                  <div class="padd" style="height:650px">
                    <div class="alert alert-success">
                      <b>Reminder: Please print your reservation summary and take note of your reservation code for reservation inquiry.</b> </br>
                      <b>Note: You need to pay on our Gcash number (+63 978545345 - CHARIE SANGRADOR) and send the proof of patment including the Ref. number.</b>
                    </div>

                    <h3 style="text-align:center">Charie's Catering Services</h3>
<h4 style="text-align:center">Bunawan</h4>
<h4 style="text-align:center">Tel. No. : 435-00787</h4>
<h4 style="text-align:center">Email : Charie@gmail.com</h4>
<h4 style="text-align:center">Facebook : facebook.com/Chariesangrador</h4>
<hr>
...
<div class="form-group">
                      <label class="control-label col-lg-4" for="title">Prof of Payment (Gcash)</label></br>
                      <div class="col-lg-8"> 
